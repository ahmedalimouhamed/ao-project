        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item menu-open">
                    <a href="#" class="nav-link @if(request()->routeIs('admin.settings') || request()->routeIs('admin.update-admin-details')) active @endif">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{-- route('admin.update-admin-details') --}}" class="nav-link  @if( (request()->routeIs('admin.update-admin-details'))) active @endif">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item menu-open">
                    <a href="#" class="nav-link @if(request()->routeIs('admin.sections') || request()->routeIs('admin.categories')|| request()->routeIs('admin.products')) active @endif">
                        <i class="nav-icon fas fa-th"></i>
                        <p>
                            Catalogues
                            <i class="right fas fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{-- route('admin.sections') --}}" class="nav-link @if( (request()->routeIs('admin.sections'))) active @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Sections</p>
                            </a>
                        </li>
